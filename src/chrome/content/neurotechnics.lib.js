        ...
        regex.test = function(value, type) {
            ...
            if (obj instanceof RegExp)  {
                ...
                switch (type.toLowerCase()) {
                    ...
                    case 'localdomain':
                        reg = /^((25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[1-9])\.(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[1-9]|0)\.(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[1-9]|0)\.(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[0-9])|localhost|([a-zA-Z0-9\-]+\.)*[a-zA-Z0-9\-]+\.(com|edu|gov|int|mil|net|org|biz|arpa|info|mobi|name|pro|aero|coop|museum|local|localhost|int|internal|intranet|[a-zA-Z]{2}))?$/i;
                        break;
